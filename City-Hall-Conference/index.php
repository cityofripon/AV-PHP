...
<tr>
		<td>
				<button name="vol-100"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >Volume Max</button>
<br>
				<button name="vol-90"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >5</button>
<br>
				<button name="vol-70"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >4</button>
<br>
				<button name="vol-50"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >3</button>
<br>
				<button name="vol-40"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >2</button>
<br>
				<button name="vol-10"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >1</button>
<br>
				<button name="vol-0"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >Volume Mute</button>
		</td>
		<td>
		</td>
