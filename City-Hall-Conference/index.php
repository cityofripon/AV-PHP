...
<tr>
		<td>
				<button name="vol-max"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >Volume Max</button>
<br>
				<button name="vol-5"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >5</button>
<br>
				<button name="vol-4"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >4</button>
<br>
				<button name="vol-3"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >3</button>
<br>
				<button name="vol-2"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >2</button>
<br>
				<button name="vol-1"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >1</button>
<br>
				<button name="vol-mute"class="btn btn-primary" style="width:235; height: 55; font-size: 24pt; font-weight:400;" >Volume Mute</button>
		</td>
		<td>
		</td>
